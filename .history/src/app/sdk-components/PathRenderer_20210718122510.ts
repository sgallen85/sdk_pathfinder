...
class PathRenderer {
  ...
  private material: THREE.Material = new THREE.MeshBasicMaterial({ color: 0x00ff00 });
  ...
  public onEvent = function(type, data) {
  }

  public onInputsUpdated = function(previous) {
  };

  public onTick = function(tickDelta) {
  };
